...
def helper(params, tod, z, to_fit):
    ...
    pred, derivs = jit_conv_int_gnfw_elliptical_two_bubbles(e, theta, params, xy, z, xb1, yb1, rb1, xb2, yb2, rb2, r_map = 10.0*60., dr = 0.5, argnums = tuple(argnums))
...
to_fit[[1,2,3,4,5,6,7,8,10,11,12,14,15,16,18,19,20]]=False  #C500, beta fixed
