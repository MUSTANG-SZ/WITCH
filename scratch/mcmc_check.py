...
from witch.forward_modeling import make_tod_stuff, sample
from witch.forward_modeling import sampler as my_sampler
...
from witch.utils import *
from witch.core import model as mink_model
from witch.grid import make_grid_from_wcs
from witch.forward_modeling import make_tod_stuff, sample
from witch.forward_modeling import sampler as my_sampler
from witch.fitter import get_outdir, _make_parser, load_tods, process_tods, load_config
...
xyz = make_grid_from_wcs(skymap.wcs, skymap.map.shape[0], skymap.map.shape[1], 0.00116355, 0.00000969,)
model.xyz = xyz
print("skymap, xyz: ", skymap.map.shape, model.xyz[0].shape, model.xyz[1].shape)
...
truths = np.array(model.pars) #make a copy of params to keep
print(params)
