...
from witch.containers import Model, Model_xfer, MetaModel
...
def load_cfg(cfg):
    ...
    for dset_name in dset_names:
        ...
        if "load_tods" in cfg["datasets"][dset_name]["funcs"]:
            cfg["datasets"][dset_name]["funcs"]["load"] = cfg["datasets"][dset_name][ "funcs"]["load_tods"]
        elif "load_maps" in cfg["datasets"][dset_name]["funcs"]:
            cfg["datasets"][dset_name]["funcs"]["load"] = cfg["datasets"][dset_name]["funcs"]["load_maps"]
        get_files = eval(cfg["datasets"][dset_name]["funcs"]["get_files"])
